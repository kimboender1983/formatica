...
<template>
  ...
  >
    ...
    <input
      ...
      class="h-2 w-full cursor-pointer appearance-none rounded-full bg-gray-200 accent-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 disabled:pointer-events-none"
      @input="onInput"
